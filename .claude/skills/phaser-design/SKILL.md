...
# Phaser Design — Visual Office Workflow
...
- Instruction: read `.claude/skills/phaser-design/reference.md` if you need the asset catalog or code examples
...
- **Consult reference.md** (`.claude/skills/phaser-design/reference.md`) for the full asset catalog, code examples, and detailed technical guidance during implementation
